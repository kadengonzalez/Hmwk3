	...
	public static String evaluatePassword(String input) {
		...
		while (running) {
			...
			if (foundUpperCase && foundLowerCase && 
					foundNumericDigit && foundSpecialChar && currentCharNdx >= 4) { 
				/* Check if all prior password conditions are met, 
				  if they are, check if we have adequate length, then... */
		...
		if (!foundLongEnough)
			errMessage += "Long Enough >= 8; "; //to let them know how long it needs to be
