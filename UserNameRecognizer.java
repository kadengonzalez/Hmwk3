	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// A-Z, a-z -> State 1 : USING NUMBERS HAS BEEN TAKEN OUT OF INITIAL USERNAME CHARACTER ALLOWANCE
			...
			case 1: 
				...
				//  2: a PERIOD, UNDERSCORE, OR DASH that transitions to state 2 
				...
				// . -> State 2
				else if (currentChar == '.' || currentChar == '_' || currentChar == '-') {	// Check for PERIOD, UNDERSCORE, OR DASH
					nextState = 2;
		...
		case 2:
			...
			userNameRecognizerErrorMessage += "A Username must not end with character after a period, "
					+ "underscore, or dash. \n And the character after a period, underscore, or dash must be A-Z, a-z, 0-9.\n";
			//Edited to include requirement for the user to know
			return userNameRecognizerErrorMessage;
